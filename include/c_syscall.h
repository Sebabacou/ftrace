...
/**
 * @brief Print syscall on stderr.
 *
 * @param regs Structure containing registers value relative to a syscall.
 */
void print_syscall(struct user_regs_struct *regs);


/* The maximum syscall known to the program. */
...
static syscall_t TABLE[330] = {
    ...
    {14, "rt_sigprocmask", 4,
        {NUM, NUM, CONST_KERNEL_SIGSET_T_P, KERNEL_SIGSET_T_P, NUM, 0, 0}},
    ...
    {23, "select", 5,
        {NUM, NUM, FD_SET_P, FD_SET_P, FD_SET_P, STRUCT_TIMEVAL_P, 0}},
    ...
    {35, "nanosleep", 2,
        {NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P, 0, 0, 0, 0}},
    {36, "getitimer", 2, {NUM, NUM, STRUCT_ITIMERVAL_P, 0, 0, 0, 0}},
    {37, "alarm", 1, {UNSIGNED, UNSIGNED, 0, 0, 0, 0, 0}},
    {38, "setitimer", 3,
        {NUM, NUM, CONST_STRUCT_ITIMERVAL_P, STRUCT_ITIMERVAL_P, 0, 0, 0}},
    {39, "getpid", 1, {NUM, VOID, 0, 0, 0, 0, 0}},
    {40, "sendfile", 4, {NUM, NUM, NUM, NUM_P, NUM, 0, 0}},
    {41, "socket", 3, {NUM, NUM, NUM, NUM, 0, 0, 0}},
    {42, "connect", 3,
        {NUM, NUM, CONST_STRUCT_SOCKADDR_P, SOCKLEN_T, 0, 0, 0}},
    {43, "accept", 3, {NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0, 0}},
    {44, "sendto", 6,
        {NUM, NUM, CONST_VOID_P, NUM, NUM, CONST_STRUCT_SOCKADDR_P,
            SOCKLEN_T}
    },
    {45, "recvfrom", 6,
        {NUM, NUM, VOID_P, NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P}},
    ...
    {51, "getsockname", 3,
        {NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0, 0}},
    {52, "getpeername", 3,
        {NUM, NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0, 0}},
    ...
    {78, "getdents", 3,
        {NUM, UNSIGNED, STRUCT_LINUX_DIRENT_P, UNSIGNED, 0, 0, 0}},
    ...
    {96, "gettimeofday", 2,
        {NUM, STRUCT_TIMEVAL_P, STRUCT_TIMEZONE_P, 0, 0, 0, 0}},
    ...
    {126, "capset", 2,
        {NUM, CAP_USER_HEADER_T, CONST_CAP_USER_DATA_T, 0, 0, 0, 0}},
    ...
    {142, "sched_setparam", 2,
        {NUM, NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0, 0}},
    {143, "sched_getparam", 2, {NUM, NUM, STRUCT_SCHED_PARAM_P, 0, 0, 0, 0}},
    {144, "sched_setscheduler", 3,
        {NUM, NUM, NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0}},
    ...
    {148, "sched_rr_get_interval", 2,
        {NUM, NUM, STRUCT_TIMESPEC_P_, 0, 0, 0, 0}},
    ...
    {164, "settimeofday", 2,
        {NUM, CONST_STRUCT_TIMEVAL_P, CONST_STRUCT_TIMEZONE_P, 0, 0, 0, 0}},
    {165, "mount", 5,
        {NUM, STRING, STRING, STRING, UNSIGNED, CONST_VOID_P, 0}},
    ...
    {180, "nfsservctl", 3,
        {NUM, NUM, STRUCT_NFSCTL_ARG_P, UNION_NFSCTL_RES_P, 0, 0, 0}},
    ...
    {208, "io_getevents", 5,
        {NUM, AIO_CONTEXT_T, NUM, NUM, STRUCT_IO_EVENT_P, STRUCT_TIMESPEC_P,
            0}
    },
    {209, "io_submit", 3, {NUM, AIO_CONTEXT_T, NUM, STRUCT_IOCB_P, 0, 0, 0}},
    {210, "io_cancel", 3,
        {NUM, AIO_CONTEXT_T, STRUCT_IOCB_P, STRUCT_IO_EVENT_P, 0, 0, 0}},
    ...
    {217, "getdents64", 3,
        {NUM, UNSIGNED, STRUCT_LINUX_DIRENT64_P, UNSIGNED, 0, 0, 0}},
    {218, "set_tid_address", 1, {NUM, NUM_P, 0, 0, 0, 0, 0}},
    {219, "restart_syscall", 1, {NUM, VOID, 0, 0, 0, 0, 0}},
    {220, "semtimedop", 4,
        {NUM, NUM, STRUCT_SEMBUF_P, NUM, CONST_STRUCT_TIMESPEC_P, 0, 0}},
    {221, "fadvise64", 6, {0, 0, 0, 0, 0, 0, 0}},
    {222, "timer_create", 3,
        {NUM, CLOCKID_T, STRUCT_SIGEVENT_P, TIMER_T_P, 0, 0, 0}},
    {223, "timer_settime", 4,
        {NUM, TIMER_T, NUM, CONST_STRUCT_ITIMERSPEC_P, STRUCT_ITIMERSPEC_P, 0,
            0}
    },
    ...
    {227, "clock_settime", 2,
        {NUM, CLOCKID_T, CONST_STRUCT_TIMESPEC_P, 0, 0, 0, 0}},
    ...
    {230, "clock_nanosleep", 4,
        {NUM, CLOCKID_T, NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P, 0, 0}
    },
    ...
    {237, "mbind", 6,
        {NUM, VOID_P, UNSIGNED, NUM, CONST_UNSIGNED_P, UNSIGNED, UNSIGNED}},
    {238, "set_mempolicy", 3, {NUM, NUM, CONST_UNSIGNED_P, UNSIGNED, 0, 0, 0}},
    {239, "get_mempolicy", 5,
        {NUM, NUM_P, UNSIGNED_P, UNSIGNED, VOID_P, UNSIGNED, 0}},
    {240, "mq_open", 2, {MQD_T, STRING, NUM, 0, 0, 0, 0}},
    {241, "mq_unlink", 1, {NUM, STRING, 0, 0, 0, 0, 0}},
    {242, "mq_timedsend", 5,
        {NUM, MQD_T, STRING, NUM, UNSIGNED, CONST_STRUCT_TIMESPEC_P, 0}},
    {243, "mq_timedreceive", 5,
        {NUM, MQD_T, STRING, NUM, UNSIGNED_P, CONST_STRUCT_TIMESPEC_P, 0}},
    {244, "mq_notify", 2, {NUM, MQD_T, CONST_STRUCT_SIGEVENT_P, 0, 0, 0, 0}},
    {245, "mq_getsetattr", 3,
        {NUM, MQD_T, STRUCT_MQ_ATTR_P, STRUCT_MQ_ATTR_P, 0, 0, 0}},
    {246, "kexec_load", 4,
        {NUM, UNSIGNED, UNSIGNED, STRUCT_KEXEC_SEGMENT_P, UNSIGNED, 0, 0}},
    {247, "waitid", 4, {NUM, IDTYPE_T, ID_T, SIGINFO_T_P, NUM, 0, 0}},
    {248, "add_key", 5,
        {KEY_SERIAL_T, STRING, STRING, CONST_VOID_P, NUM, KEY_SERIAL_T, 0}},
    {249, "request_key", 4,
    ...
    {256, "migrate_pages", 4,
        {NUM, NUM, UNSIGNED, CONST_UNSIGNED_P, CONST_UNSIGNED_P, 0, 0}},
    ...
    {271, "ppoll", 4,
        {NUM, STRUCT_POLLFD_P, UNSIGNED, CONST_STRUCT_TIMESPEC_P,
            CONST_SIGSET_T_P, 0, 0}
    },
    {272, "unshare", 1, {NUM, NUM, 0, 0, 0, 0, 0}},
    {273, "set_robust_list", 2,
        {NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM, 0, 0, 0,
            0}
    },
    {274, "get_robust_list", 3,
        {NUM, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM_P, 0, 0, 0}},
    ...
    {278, "vmsplice", 4,
        {NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED, 0, 0}},
    {279, "move_pages", 6,
        {NUM, NUM, UNSIGNED, VOID_P, CONST_NUM_P, NUM_P,
            NUM}
    },
    {280, "utimensat", 4,
        {NUM, NUM, STRING, CONST_STRUCT_TIMESPEC, NUM, 0, 0}},
    {281, "epoll_pwait", 5,
        {NUM, NUM, STRUCT_EPOLL_EVENT_P, NUM, NUM, CONST_SIGSET_T_P, 0}},
    ...
    {286, "timerfd_settime", 4,
        {NUM, NUM, NUM, CONST_STRUCT_ITIMERSPEC_P, STRUCT_ITIMERSPEC_P, 0, 0}},
    ...
    {298, "perf_event_open", 5,
        {NUM, STRUCT_PERF_EVENT_ATTR_P, NUM, NUM, NUM, UNSIGNED, 0}},
    {299, "recvmmsg", 5,
        {NUM, NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED, STRUCT_TIMESPEC_P, 0}
    },
    ...
    {303, "name_to_handle_at", 5,
        {NUM, NUM, STRING, STRUCT_FILE_HANDLE_P, NUM_P, NUM, 0}},
    {304, "open_by_handle_at", 3,
        {NUM, NUM, STRUCT_FILE_HANDLE_P, NUM, 0, 0, 0}},
    {305, "clock_adjtime", 6, {0, 0, 0, 0, 0, 0, 0}},
    {306, "syncfs", 1, {NUM, NUM, 0, 0, 0, 0, 0}},
    {307, "sendmmsg", 4,
        {NUM, NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED, 0, 0}},
    {308, "setns", 2, {NUM, NUM, NUM, 0, 0, 0, 0}},
    {309, "getcpu", 3,
        {NUM, UNSIGNED_P, UNSIGNED_P, STRUCT__CACHE_P, 0, 0, 0}},
    {310, "process_vm_readv", 6,
        {NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED, CONST_STRUCT_IOVEC_P,
            UNSIGNED, UNSIGNED}
    },
    ...
    {314, "sched_setattr", 3,
        {NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, 0, 0, 0}},
    {315, "sched_getattr", 4,
        {NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, UNSIGNED, 0, 0}},
    ...
    {320, "kexec_file_load", 5,
        {NUM, NUM, NUM, UNSIGNED, STRING, UNSIGNED, 0}},
    ...
    {326, "copy_file_range", 6,
        {NUM, NUM, LNUM_P, NUM, LNUM_P, NUM, UNSIGNED}},
